...
abstract class SearchAssetSource {
  ...
  @GET("/stock/search")
  Future<SearchResponse> searchStock(@Query('keyword') String keyword);
  @GET("/crypto/search")
  Future<SearchResponse> searchCrypto(@Query('keyword') String keyword);
  @GET("/forex/search")
  Future<SearchResponse> searchForex(@Query('keyword') String keyword);
