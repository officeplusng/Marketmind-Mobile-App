...
class _SearchAssetDialogState extends State<SearchAssetDialog>
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //   description: "We couldn't find any matches for your search. Try using different keywords or check your spelling.",)
                        Text(
                          'TOP MATCHES',
  ...
  Widget _assetItem(String name, String symbol, String category, String price,
      double move) {
