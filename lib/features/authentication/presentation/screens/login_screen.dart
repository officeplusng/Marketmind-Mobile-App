...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthenticationCubit, AuthState>(
      ...
      return BaseScaffold(
          isLoading: state is OAuthLoading,
                    ...
                    child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            40.verticalSpace,
                            BlocListener<AuthenticationCubit, AuthState>(
                                ...
                                listener: (_, state) {
                                  if (state is OAuthSuccess) {
                                    ...
                                    final user = state.response?.toUserDto();
                                    if (user == null) {
                                      AppSnackBarHelper.showToast(
                                          'Account created',
                                    ...
                                    context.read<AccountCubit>().setUser(user);
                                    AppSnackBarHelper.showToast('Welcome',
                                        color: AppColors.greenDark,
                                        gravity: ToastGravity.TOP);
                                  ...
                                  if (state is LoginSuccess) {
                                    context
                                        .read<AccountCubit>()
                                        .setUser(state.user);
                                    AppSnackBarHelper.showToast('Welcome back',
                                        color: AppColors.greenDark,
                                        gravity: ToastGravity.TOP);
                                    context.pushRemoveUntil(RootScreen());
                                  }
